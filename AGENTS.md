...
- `bun start stroke-order-report <Family> [-c chars] [-j report.json]` — KanjiVG stroke-order agreement ([stroke-order-report.ts](packages/generator/src/commands/stroke-order-report.ts)).
