...
export function ZoomStage({ children, contentKey, overlay }: { children: ReactNode; contentKey: string; overlay?: ReactNode }) {
  ...
  const fitScale = useCallback(() => {
    ...
    const s = Math.min((vp.clientWidth - PAD * 2) / el.offsetWidth, (vp.clientHeight - PAD * 2) / el.offsetHeight, 1.5);
  ...
  return (
    <div className="relative min-h-0 flex-1">
      <div ref={viewportRef} className="studio-canvas studio-scroll absolute inset-0 overflow-auto">
        <div
