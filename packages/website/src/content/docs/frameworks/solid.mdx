---
title: SolidJS
description: 'Add a handwriting animation to a SolidJS app with the TegakiRenderer component: controlled time, effects, streaming text and the ref handle.'
head:
  - tag: title
    content: 'SolidJS Handwriting Animation | Tegaki'
---
