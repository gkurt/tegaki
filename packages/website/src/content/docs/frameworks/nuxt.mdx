---
title: Nuxt
description: 'Add a handwriting animation to a Nuxt 3 or Nuxt 4 app with the tegaki/nuxt module: SSR and client rendering, and an auto-imported TegakiRenderer.'
head:
  - tag: title
    content: 'Nuxt Handwriting Animation | Tegaki'
---
