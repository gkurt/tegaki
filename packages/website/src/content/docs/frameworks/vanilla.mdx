---
title: Vanilla JS
description: 'Animate handwriting in plain JavaScript with TegakiEngine: options, controlled time, effects, cleanup and pre-rendering on the server.'
head:
  - tag: title
    content: 'JavaScript Handwriting Animation Without a Framework | Tegaki'
---
