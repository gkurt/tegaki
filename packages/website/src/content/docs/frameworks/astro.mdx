---
title: Astro
description: Add a handwriting animation to an Astro site with the server-rendered TegakiRenderer component, font registration and effects.
head:
  - tag: title
    content: 'Astro Handwriting Animation | Tegaki'
---
