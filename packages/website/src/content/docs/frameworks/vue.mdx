---
title: Vue
description: 'Add a handwriting animation to a Vue 3 app with the TegakiRenderer component: v-model time, effects, streaming text and the exposed instance.'
head:
  - tag: title
    content: 'Vue Handwriting Animation | Tegaki'
---
