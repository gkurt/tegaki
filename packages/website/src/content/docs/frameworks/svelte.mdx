---
title: Svelte
description: 'Add a handwriting animation to a Svelte 5 app with the TegakiRenderer component: controlled time, effects and streaming text.'
head:
  - tag: title
    content: 'Svelte Handwriting Animation | Tegaki'
---
