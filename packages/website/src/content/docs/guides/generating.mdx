...
description: 'Turn any font into handwriting animation data: the stroke extraction pipelines, their options, and the bundle format Tegaki renders.'
head:
  - tag: title
    content: 'Generate Handwriting Animation Data from Any Font | Tegaki'
---
