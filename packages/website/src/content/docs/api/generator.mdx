---
title: Generator
description: 'Reference for the Tegaki generator: the options and output format for turning a font into handwriting animation data.'
head:
  - tag: title
    content: 'Generator Reference | Tegaki'
---

The Tegaki generator processes fonts and outputs stroke data for handwriting animation. Use the [studio](/tegaki/studio/) on the Tegaki website to generate font bundles.
